...
function createMovie() {
  ...
  var genre = document.getElementById('genreMovie').value;
...
var createProgramButton = document.getElementsByClassName(
...
var createMovieProgramButton = document.getElementsByClassName(
