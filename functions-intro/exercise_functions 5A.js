...
var citati = ['Nađi vremena za prijateljstvo, to je put do sreće.', 'Ama, misli dobro, pa će dobro i biti.', 'Rad rađa ideje.', 'Od ljubavi se ne živi ali se za nju gine.', 'Brak čini troje: ljubav, poverenje i strpljenje.', 'Dan bez smeha je izgubljen dan'];
randomCitat(citati);
randomCitat(citati);
randomCitat(citati);
randomCitat(citati);
